...
def main():
    ...
    parser.add_argument('--is_train', default=False) # False for inference mode
    # parser.add_argument('--resume_file', type=str, default='/path-to-data/word_embeds.glove32b.th')
    parser.add_argument('--resume_file', type=str, default='/path-to-data/ckpts/epoch.xx.th')
    parser.add_argument('--eval_set', default='tst') # 'tst' for inference mode
